...
def set_input_size(x,y):
    dataset_settings['lip']['input_size'] = [x,y]
...
def get_arguments():
    ...
    parser.add_argument("--input-dir", type=str, default='../datasets/new_datasets/test_img/', help="path of input image folder.")
    parser.add_argument("--output-dir", type=str, default='../datasets/new_datasets/test_label/', help="path of output image folder.")
...
def main():
    ...
    #args.input_dir = '../datasets/new_datasets/test_img/'
    #args.output_dir = '../datasets/new_datasets/test_label/'
    #args.model_restore = '/checkpoints/exp-schp-201908261155-lip.pth'
    ...
    dataset = SimpleFolderDataset(root=args.input_dir, input_size_list=input_size_list, transform=transform)
